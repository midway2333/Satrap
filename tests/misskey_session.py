...
class MisskeySession(AsyncSession):
    ...
    def __init__(self, session_id: str,
        ...
        self.command_handler.register_command("new", partial(cmd_new_async, self), "开始新对话")
        self.command_handler.register_command("history", partial(cmd_history_async, self), "查看此用户的所有对话")
        self.command_handler.register_command("switch", partial(cmd_switch_async, self), "切换至指定对话: /switch <session_id>")
        self.command_handler.register_command("about", partial(cmd_about_async, text=ABOUT_TEXT), "关于")
